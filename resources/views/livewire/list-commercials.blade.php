            ...
            <form wire:submit.prevent="storeUser">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" wire:model.defer="user.name" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" wire:model.defer="user.email" class="form-control" required>
                    </div>
                    <div class="form-group">
