...
@section('content')
    ...
    <div style="margin-top:0px"class="container-fluid display-table">
            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li><a href="#"><i class="fa fa-calendar" aria-hidden="true"></i><span class="hidden-xs hidden-sm">gestion des leads</span></a></li>
                            ...
                            <div  id="page-wrapper">
                                ...
                                <div style="" class="container-fluid">
                                    <div style="" class="row" id="main" >
                                        <div style="background: rgb(56,59,95);
background: linear-gradient(90deg, rgba(56,59,95,1) 0%, rgba(49,59,151,1) 35%, rgba(71,161,180,1) 100%);" class="col-sm-12 col-md-12 well" id="content">
                                            <h1 style="background: rgb(56,59,95);
background: linear-gradient(90deg, rgba(56,59,95,1) 0%, rgba(49,59,151,1) 35%, rgba(71,161,180,1) 100%);color: white;">You are logged in as user</h1>
                                        </div>
                                    </div>
                                    <!-- /.row -->
                                </div>
